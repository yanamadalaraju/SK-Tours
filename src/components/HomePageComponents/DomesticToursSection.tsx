...
const TourCarousel: React.FC<{ 
  ...
  useEffect(() => {
    const updateCardSizes = () => {
      if (window.innerWidth < 768) {
        setVisibleCards(1);
        setCardWidth('250px'); // Reduced from 280px for mobile
  ...
  if (loading || destinationsLoading) {
    return (
      <div className="rounded-2xl shadow-lg p-4 md:p-6 mb-8 md:mb-12 border border-gray-100 relative overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50">
  ...
  if (error && tours.length === 0) {
    return (
      <div className="rounded-2xl shadow-lg p-4 md:p-6 mb-8 md:mb-12 border border-gray-100 relative overflow-hidden bg-gradient-to-br from-red-50 to-pink-50">
        <div className="text-center py-6 md:py-8">
  ...
  if (filteredTours.length === 0 && tours.length > 0) {
    return (
      <div className="rounded-2xl shadow-lg p-4 md:p-6 mb-8 md:mb-12 border border-gray-100 relative overflow-hidden bg-gradient-to-br from-yellow-50 to-orange-50">
        <div className="text-center py-6 md:py-8">

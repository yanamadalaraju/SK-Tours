    ...
    <footer className="bg-gradient-to-r from-[#0F1F5C] via-[#1F3F93] to-[#0F1F5C] text-white pt-8 pb-6">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Logo & About - Full width on mobile, then responsive */}
          <div className="text-center sm:text-left sm:col-span-2 lg:col-span-1">
            <div className="flex flex-col sm:flex-row lg:flex-col items-center sm:items-start lg:items-center gap-4">
              ...
              <div className="flex-1">
                <p className="text-white/80 text-sm mb-4 text-center sm:text-left lg:text-center">
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-center sm:text-left">Quick Links</h3>
              ...
              {quickLinks.map((link, index) => (
                <li key={index} className="text-center sm:text-left">
                  <NavLink 
                    to={link.href} 
                    className={({ isActive }) => 
                      `text-sm flex items-center justify-center sm:justify-start transition-all duration-300 hover:translate-x-1
                       ${isActive
                         ? "text-[#E31B23] font-semibold"
                         : "text-white/80 hover:text-[#E31B23]"
                       }`
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-center sm:text-left">Company</h3>
            <ul className="space-y-2">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <h3 className="text-lg font-bold mb-4 text-center sm:text-left">Contact Us</h3>
            <ul className="space-y-3 text-sm">
              <li className="flex flex-col sm:flex-row gap-2 text-white/80 items-center sm:items-start text-center sm:text-left">
              ...
              <li className="pt-4 mt-4 border-t border-white/20">
                <h4 className="font-bold mb-3 border-b-2 inline-block border-[#E31B23] text-center sm:text-left">
                  Member of
                </h4>

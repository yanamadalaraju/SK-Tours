        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <NavLink to={link.href} className={linkClass} end>
                    {link.label}
                  </NavLink>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex gap-2 text-white/80">
                <MapPin size={16} /> Dadar West, Mumbai 400028
              </li>
              <li className="flex gap-2 text-white/80">
                <Phone size={16} /> +91 9820870771
              </li>
              <li className="flex gap-2 text-white/80">
                <Mail size={16} /> salil@sktt.in
              </li>

              <li className="pt-4 border-t border-white/20">
                <h4 className="font-bold mb-2 border-b-2 inline-block border-[#E31B23]">
                  Member of
                </h4>
                <div className="flex gap-3 mt-2">
                  {associationLogos.map((item, i) => (
                    <img key={i} src={item.logo} alt={item.name} className="h-10" />
                  ))}
                </div>
              </li>
            </ul>

...
import { useState, useEffect, useRef } from "react";
import video1 from "../assets/video1 (1) (1) (1) (1) (1).mp4";
import video2 from "../assets/compressed_video2.webm";
import video3 from "../assets/2098988-uhd_3840_2160_30fps (1) (1) (1).mp4";
...
const Hero = () => {
  ...
  return (
    <section className="relative text-white overflow-hidden min-h-[90vh] flex items-center">
      ...
      {/* Empty content area - you can add your own content here later */}
      <div className="relative z-20 w-full py-16">
        <div className="container mx-auto px-4">
      ...
      <div className="absolute bottom-8 right-8 z-20">
        <div className="flex items-center gap-4 bg-black/40 backdrop-blur-lg rounded-2xl p-4 border border-white/20">
          <button
            onClick={togglePlay}
            className="p-3 bg-white/20 rounded-xl hover:bg-white/30 transition-all duration-300"
          >
            {isPlaying ? "⏸️" : "▶️"}
          </button>
          <div className="flex items-center gap-2">

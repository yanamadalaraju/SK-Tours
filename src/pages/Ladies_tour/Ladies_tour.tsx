...
const TourPackages = () => {
  ...
  const getCurrentStateTours = () => {
    ...
    console.log(`Found ${filtered.length} ladies special tours for ${selectedState}:`, filtered);
    return filtered;
  };
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Showing {filteredTours.length} of {currentTours.length} ladies special tours • Best prices guaranteed
                </p>
              </div>

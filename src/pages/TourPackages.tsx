...
//             <div className="bg-white rounded-xl shadow-lg p-5 border border-blue-100 sticky top-24">
...
//               {/* Duration */}
//               <div className="mb-5">
//                 <h3 className="font-semibold text-gray-700 mb-2 text-sm">Duration</h3>
...
//               {/* Departure Date */}
//               <div className="mb-5">
//                 <h3 className="font-semibold text-gray-700 mb-2 text-sm">Departure date</h3>
...
//                       />
//                       <span className="text-gray-600 group-hover:text-gray-800 text-xs">{month}</span>
//                     </label>
//                   ))}
//                 </div>
//               </div>
...
//                   <h3 className="font-semibold text-gray-700 text-sm">Indian Tours</h3>
//                 </div>
//                 <div className={`${showMoreIndian ? "max-h-40" : "max-h-28"} overflow-y-auto space-y-1.5 pr-2`}>
//                   {[
...
//                         className="data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600 h-4 w-4" 
//                       />
//                       <span className="text-gray-600 group-hover:text-gray-800 text-xs">{place}</span>
//                     </label>
//                   ))}
//                 </div>
//                 <button
//                   onClick={() => setShowMoreIndian(!showMoreIndian)}
//                   className="mt-1.5 text-blue-600 text-xs font-medium hover:text-blue-800 hover:underline"
//                 >
...
//               <div>
//                 <div className="flex justify-between items-center mb-2">
//                   <h3 className="font-semibold text-gray-700 text-sm">World Tours</h3>
//                 </div>
//                 <div className={`${showMoreWorld ? "max-h-40" : "max-h-28"} overflow-y-auto space-y-1.5 pr-2`}>
//                   {[
...
//               <div className="relative p-5 min-h-[130px] flex items-center">
//                 <div className="text-white">
//                   <h1 className="text-2xl font-bold mb-1">Andaman Tour Packages</h1>
//                   <p className="text-sm opacity-95 max-w-2xl leading-relaxed">
...
//                 <div>
//                   <h2 className="text-lg font-bold text-gray-800">Andaman Holiday Packages</h2>
//                   <p className="text-gray-600 text-xs mt-0.5">
//                     Showing {filteredTours.length} of {tourData.length} tours • Best prices guaranteed
//                   </p>
//                 </div>

//                 <div className="flex items-center gap-2 flex-wrap">
//                   <Tabs defaultValue="grid" className="w-auto">
//                     <TabsList className="grid grid-cols-2 w-26 h-8">
...
//             {/* Tours Grid - Optimized Cards */}
//             <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
//               {filteredTours.map((tour, index) => (
//                 <div key={index} className="flex flex-col group">
//                   {/* Code and Duration Header */}
//                   <div className="bg-white border border-gray-200 rounded-t-lg p-2 shadow-sm">
//                     <div className="grid grid-cols-3 gap-0 border border-gray-300 rounded overflow-hidden bg-gray-50 text-xs">
//                       <div className="bg-gray-100 border-r border-gray-300 p-1.5">
//                         <div className="font-semibold text-gray-600 text-center">CODE</div>
//                       </div>
//                       <div className="bg-white border-r border-gray-300 p-1.5">
//                         <div className="font-bold text-gray-900 text-center">{tour.code}</div>
//                       </div>
//                       <div className="bg-gray-50 p-1.5">
//                         <div className="font-bold text-blue-700 text-center">{tour.duration}</div>
//                       </div>
//                     </div>
//                   </div>

//                   {/* Tour Card - Slightly Increased Size */}
//                   <div className="bg-white rounded-b-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden cursor-pointer border border-gray-200 border-t-0 flex flex-col flex-1 group-hover:-translate-y-0.5">
//                     {/* Image Section */}
...
//                       <Badge className="absolute top-2 left-2 bg-white text-blue-700 font-bold border border-blue-200 shadow-sm text-xs px-2 py-0">
//                         {tour.badge}
//                       </Badge>
...
//                       {/* Title */}
//                       <h3 className="font-semibold text-gray-800 line-clamp-2 mb-2 text-sm leading-tight min-h-[40px]">
//                         {tour.title}
//                       </h3>
...
//                         <p className="text-xs text-gray-600 mt-0.5">{tour.emi}</p>
//                       </div>
...
//                           size="sm" 
//                           variant="outline" 
//                           className="flex-1 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white transition-colors text-xs h-8"
...
//                         <Button 
//                           size="sm" 
//                           className="flex-1 bg-blue-600 hover:bg-blue-700 text-white transition-colors shadow-sm text-xs h-8"
//                         >
//                           Book Now
//                         </Button>
//                       </div>
...
//                 <Button 
//                   size="lg" 
//                   className="bg-blue-600 hover:bg-blue-700 px-8 py-2 text-white shadow-md hover:shadow-lg transition-all text-sm"
//                 >
//                   Load More Tours
//                 </Button>
//               </div>
...
//                 <h3 className="text-base font-semibold text-gray-600 mb-1">No tours found</h3>
//                 <p className="text-gray-500 text-xs mb-3">Try adjusting your filters to see more results.</p>
//                 <Button 
//                   onClick={clearAllFilters}

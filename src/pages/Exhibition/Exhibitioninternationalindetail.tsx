...
<div className="w-full overflow-hidden border-black border mb-2">
  <div className="flex w-full divide-x divide-black">
    ...
    {/* Search - 5th column */}
  <div className="w-1/5 flex items-center bg-red-600">
  <style>{`
    input::placeholder {
  ...
  <form onSubmit={handleSearch} className="flex w-full h-full">
    <input
      ...
      className="flex-1 px-2 py-2 text-sm outline-none border-none w-full bg-red-600 text-white"
      style={{ color: "white" }}
    />
    {searchQuery && (
      <button
        ...
        className="px-1 text-white hover:text-gray-200"
      >
        ✕
      </button>
    )}
              ...
              <div className="bg-[#2E4D98] rounded-md shadow-sm p-2 lg:p-4">
                ...
                {activeTab === "flights-&-hotels" && (
                  <div className="bg-[#E8F0FF] rounded-lg p-0.5 w-full overflow-x-hidden">
                    <div className="bg-[#FFEBEE] rounded-lg p-0 mb-0 w-full">

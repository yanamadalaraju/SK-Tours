// Bungalowpdf.tsx - 4 Separate Simple Tables (No Description Label)
...
const styles = StyleSheet.create({
    ...
    // Simple table styles (no Description label)
    simpleTable: {
        marginBottom: 15,
        borderWidth: 1,
        borderColor: '#000',
...
const Bungalowpdf: React.FC<BungalowpdfProps> = ({ bungalow, images, currentImageIndex }) => {
    ...
    const carouselImages = images.length > 0
        ...
        : [bungalow.main_image ? getImageUrl(bungalow.main_image) : ''];

    const allImages = carouselImages.length > 0 ? carouselImages : [];
    ...
    return (
        <Document>
            ...
            <Page size="A4" style={styles.page}>
                ...
                {allImages[0] && (
                    <Image src={allImages[0]} style={styles.image} />
                )}
                ...
                {allImages.length > 1 && (
                    <View style={styles.section}>
                        <Text style={styles.sectionTitle}>Bungalow Images</Text>
            ...
            {/* Page 5: Places Near By */}
            <Page size="A4" style={styles.page}>
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>Places Near By</Text>
                    <View style={styles.infoBox}>
                        <Text style={styles.value}>{bungalow.places_nearby || "No nearby places listed"}</Text>
                    </View>
                </View>

    ...
    >
      Send Us Your Inquiry
            ...
            <div className="max-w-4xl mx-auto mt-9">
             ...
             <div className="bg-white rounded-xl shadow-xl p-6 md:p-8 border-2 border-black">
                    ...
                    <div className="grid md:grid-cols-3 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          required
                          className="w-full px-4 py-3 border border-black rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors"
                    ...
                    <div className="grid md:grid-cols-3 gap-5">
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className="w-full px-4 py-3 border border-black rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors bg-white"
                        >
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        rows={5}
                        className="w-full px-4 py-3 border border-black rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors resize-none"
                  ...
                  <div className="pt-6 border-t border-gray-100">
                    <div className="flex flex-col sm:flex-row items-center justify-between">
                      ...
                      <button
                        ...
                        className={`px-8 py-3 rounded-lg font-semibold text-white flex items-center gap-3 transition-all ${isSubmitting
                    ...
                    <div>
                      ...
                      <div className="space-y-2 pl-7">
                        ...
                        <div className="flex justify-center py-2 border-b border-gray-200">
                          <span className="text-gray-700">Closed on Sunday and Public Holidays</span>
                        </div>
                ...
                {faqData.map((faq, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <ChevronDown className={`w-5 h-5 text-blue-600 transition-transform duration-300 ${activeFaq === index ? 'rotate-180' : ''
                        }`} />
                    </button>
                    {activeFaq === index && (

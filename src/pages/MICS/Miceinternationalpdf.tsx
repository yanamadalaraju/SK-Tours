...
const Miceinternationalpdf: React.FC<TourPdfDocumentProps> = ({
    tour,
    tourType,
    isGroupTour,
    selectedCostMonth,
...
const renderAllDeparturesTable = () => {
    // First priority: Use departures.descriptions (Free Flow Text)
    if (tour?.departures?.descriptions && tour.departures.descriptions.length > 0) {
        return (
            <View style={styles.departureInfo}>
                <Text style={[styles.title, { marginBottom: 8 }]}>Departure Information:</Text>
    ...
    // Fallback: Use departures.data (Tabular format)
    ...
    return (
        <View style={styles.highlight}>
            <Text style={styles.text}>No departure information available</Text>
        </View>
    );
};
            ...
            <Page size="A4" style={styles.page}>
                ...
                {tour?.description && (
                    <View style={[styles.overviewBox, { marginBottom: 15 }]}>
                        <Text style={[styles.title, { marginBottom: 4 }]}>Mice Overview:</Text>
...
export default Miceinternationalpdf;
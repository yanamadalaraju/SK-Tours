...
const clearSearch = () => {
  ...
  useEffect(() => {
    ...
    console.log("Formatted tours (all festival tours for this state):", formatted);
...
const handleIndianTourChange = (tour: string, checked: boolean) => {
  if (checked) {
    // Clear world tours when selecting an Indian state
            ...
            return (
              <div 
                ...
                onClick={() => {
                  ...
                  navigate(`/intl-festival/${encodedDestination}`);
                }}
              >
                <Checkbox
                  checked={isSelected}

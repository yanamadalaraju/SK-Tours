...
const InternationalFestival = () => {
  ...
  const getCurrentStateTours = () => {
    ...
    console.log("Filtering festival tours for:", selectedState, "| International?", isInternationalPage);
    ...
    console.log("Filtered festival tours count:", filtered.length);
    return filtered;
  };
              ...
              <div className="bg-gradient-to-br from-blue-100 to-blue-50 rounded-2xl shadow-lg p-6 border border-blue-200 sticky top-24">
                <div className="flex justify-between items-center mb-6 bg-white p-2 rounded-lg border border-black">
                  <h2 className="text-2xl font-bold text-[#2E4D98]">
                    {isInternationalPage ? "Intl Festival Tours" : "Festival Tours"}
                  </h2>
                  <button
                ...
                <div>
                  <div className="flex justify-between items-center mb-6 bg-white p-2 rounded-lg border border-black">
                    <h2 className="text-2xl font-bold text-[#2E4D98]">Intl Festival Tours</h2>
                  </div>
                            ...
                            return (
                              <div 
                                ...
                                onClick={() => {
                                  ...
                                  navigate(`/intl-festival/${encodeURIComponent(countryName)}`);
                                }}
                              >
                                <Checkbox
                                  checked={isSelected}
...
export default InternationalFestival;
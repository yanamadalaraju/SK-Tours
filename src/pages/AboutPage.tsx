                ...
                >
                  <div className="space-y-8 text-white">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 text-lg md:text-xl leading-relaxed text-justify">
                ...
                >
                  <div className="space-y-10 text-white">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 text-lg md:text-xl mb-4 leading-relaxed text-justify">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                          ...
                          >
                            ...
                            <span className="text-blue-100 text-lg text-justify">{service}</span>
                          </div>
                        ))}
                      </div>
                    </div>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-white">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-blue-100 text-lg md:text-xl leading-tight text-justify">
        ...
        <section className="bg-blue-100 border-blue-200">
          <div className="py-1">
            <div className="max-w-12xl mx-auto">
              ...
              <div className="max-w-8xl mx-auto px-6 mb-8">
                <div
                  className="rounded-2xl shadow-lg px-7 py-10 border border-blue-400"
                  style={{
                    background: 'radial-gradient(circle at center, #0F1F5C  70%, #0F1F5C  70%, #0F1F5C 70%, #0F1F5C  70%)',
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                      {[
                        ...
                        <div key={index} className="flex items-center gap-3">
                          ...
                          <span className="text-white text-lg md:text-xl text-justify">{item}</span>
                        </div>
                      ))}
                    </div>

                    {/* Outro */}
                    <p className="text-lg md:text-xl text-white leading-relaxed mt-6 text-justify">

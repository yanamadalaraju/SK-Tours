    ...
    <div style={{ 
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '32px 16px' }}>
        ...
        <div style={{ 
          ...
          {tripType === 1 && bookingData?.return_flight === 1 && bookingData?.return && (
              ...
              <tbody>
                {passengerDetails.map((passenger, index) => (
                  <tr key={index} style={{ borderBottom: '1px solid #f3f4f6' }}>
                    <td style={{ padding: '16px 12px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: '14px', color: '#6b7280' }}>
                            Age: {passenger.age} • DOB: {passenger.dob}
                          </div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td style={{ padding: '16px 12px', color: '#374151' }}>
                      {passenger.passportExpireDate || 'N/A'}
                    </td>
                    <td style={{ padding: '16px 12px' }}>
                      <span style={{
                        padding: '6px 12px',
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div style={{ fontSize: '32px', fontWeight: 'bold', color: '#059669' }}>
                ₹{bookingData?.total_amount?.toLocaleString('en-IN') || '0'}
              </div>
            </div>
          </div>
        </div>

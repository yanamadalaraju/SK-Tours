  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      const bookingPayload = {
        id: flightData?.id || "6051",
        onward_date: flightData?.onward_date || "2026-12-22",
        return_date: isRoundTrip ? (flightData?.returnDate || "2026-12-26") : "",
        adult: passengers.adults,
        children: passengers.children,
        infant: passengers.infants,
        dep_city_code: flightData?.dep_city_code || "AMD",
        arr_city_code: flightData?.arr_city_code || "AUH",
...
end_user_ip: endUserIp || import.meta.env.VITE_PROD_FLIGHT_API_END_USER_IP,
token: token || import.meta.env.VITE_PROD_FLIGHT_API_TOKEN      };

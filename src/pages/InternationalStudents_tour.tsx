...
const TourPackages = () => {
        ...
        const results = await Promise.all(
          allTours.map(async (tour) => {
            try {
              ...
              console.error("Error fetching student tour details for", tour.tour_id, err);
              return { 
                tourId: tour.tour_id, 
                imageUrl: "", 
                emiPrice: "0",
  ...
  const getCurrentStateTours = () => {
    ...
    console.log("Filtering student tours for:", selectedState, "| International?", isInternationalPage);
            ...
            <div className="bg-gradient-to-br from-blue-100 to-blue-50 rounded-2xl shadow-lg p-6 border border-blue-200 sticky top-24">
              <div className="flex justify-between items-center mb-6 bg-white p-2 rounded-lg border border-black">
                <h2 className="text-2xl font-bold text-[#2E4D98]">
                  {isInternationalPage ? "Intl Student Tours" : "Student Tours"}
                </h2>
                <button 
                          ...
                          return (
                            <div 
                              ...
                              onClick={() => {
                                ...
                                navigate(`/intl-students_tours/${encodeURIComponent(countryName)}`);
                              }}
                            >
                              <Checkbox
                                checked={isSelected}

...
// // Flight Results Component - Enhanced Version
// const FlightResults = ({ searchData, onBack, travellers }: { searchData: any; onBack: () => void; travellers: TravellerCount }) => {
//   const [activeTab, setActiveTab] = useState<string | null>(null);
//   const [flights, setFlights] = useState<Flight[]>([]);
//   const [loading, setLoading] = useState(true);
...
//                     {[
//                       { label: 'Non-stop only', value: 'nonstop', count: flights.filter(f => f.flight_type === 'Non-stop').length },
//                       { label: '1 Stop', value: '1stop', count: flights.filter(f => f.flight_type === '1 Stop').length },
//                       { label: '2+ Stops', value: '2stops', count: flights.filter(f => f.flight_type?.includes('Stop') && !f.flight_type.includes('Non')).length }
//                     ].map((stop) => (
...
//                     <input type="range" min="5000" max="50000" className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer" />
...
//                   <div className="space-y-2">
//                     {[
//                       { label: 'Morning (00:00 - 11:59)', icon: '🌅' },
//                       { label: 'Afternoon (12:00 - 16:59)', icon: '☀️' },
//                       { label: 'Evening (17:00 - 20:59)', icon: '🌆' },
//                       { label: 'Night (21:00 - 23:59)', icon: '🌙' }
//                     ].map((time) => (
//                       <label key={time.label} className="flex items-center gap-3 cursor-pointer group">
//                         <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-orange-600 focus:ring-orange-500" />
...
//                 Showing <span className="font-semibold text-gray-900">{flights.length}</span> of {flights.length} flights
//               </div>
//             </div>
...
//                 </div>
//                 <p className="text-gray-600 font-medium mb-2">No flights found</p>
...
//                     {/* Fare Summary for selected travellers */}
